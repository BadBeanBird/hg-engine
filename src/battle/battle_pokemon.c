...
u8 TypeEffectivenessTable[][3] =
{
    ...
    { TYPE_GROUND, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE },
    ...
    { TYPE_ROCK, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE },
    ...
    { TYPE_STEEL, TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE },
    { TYPE_STEEL, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE },
    { TYPE_STEEL, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE },
    { TYPE_STEEL, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE },
    ...
    { TYPE_STEEL, TYPE_DRAGON, TYPE_MUL_SUPER_EFFECTIVE },
    ...
    { TYPE_ELECTRIC, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE },
